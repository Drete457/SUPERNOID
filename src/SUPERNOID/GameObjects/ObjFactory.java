       ...
       // Block[] blocks = new Block[numberOfColumns * numberOfRows];
        ...
        for (int rowNumber = 0; rowNumber < numberOfRows; rowNumber++) {
            ...
            for (int colNumber = 0; colNumber < numberOfColumns; colNumber++) {
                game.blocks[index++] = new Block((colNumber * Block.BLOCKWIDTH) + BLOCK_LEFT_PADDING + initialHorizontalPos,(rowNumber * Block.BLOCKHEIGHT) + BLOCK_TOP_PADDING + initialVerticalPos);
